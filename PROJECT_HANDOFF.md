...
**Версия:** 2.0.0 (релизный коммит v2.0.0; предыдущий релиз = `1f12cbf`); v2.0: этап 1/3 = `370a217`, этап 2/3 = `994ae26` (частичный), CI-хотфикс = `322fd7e`, этап 3/3 = `be1a4a6`  
**Статус:** Релиз v2.0.0 собран: этапы 1–3/3, CI-хотфикс, миграция 8 версионных сьютов, чистый манифест (убран ключ-комментарий `//ESM`); публикация в Edge Add-ons — следующий шаг  
...
Следующая синхронизация — после публикации v2.0.0 в Edge Add-ons (листинг: `tools/edge-listing-metadata.txt`).
