...
1. Скачайте архив `ai-context-monitor-v2.0.5.zip` со страницы релиза: <https://github.com/shtakan/ai-context-monitor/releases/tag/v2.0.5>
