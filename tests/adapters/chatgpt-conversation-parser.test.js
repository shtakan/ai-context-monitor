...
const hasLiveFixture = fs_live.existsSync(path_live.join(__dirname, '..', '..', 'chatgpt-conversation-sample.json'));

(hasLiveFixture ? describe : describe.skip)('ChatGPT живой образец (chatgpt-conversation-sample.json)', () => {
