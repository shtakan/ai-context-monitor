 ...
 * как минимум заголовки 2.0.8, 2.0.7, 2.0.6, 2.0.5, 2.0.4, 2.0.3, 2.0.2, 2.0.1, 2.0.0, 1.19.0, 1.18.0, 1.17.0, 1.16.0, 1.15.3.
 *
...
const REQUIRED_VERSIONS = ['2.0.8', '2.0.7', '2.0.6', '2.0.5', '2.0.4', '2.0.3', '2.0.2', '2.0.1', '2.0.0', '1.19.0', '1.18.0', '1.17.0', '1.16.0', '1.15.3'];
...
describe('CHANGELOG.md: формат версионных заголовков (Keep a Changelog)', () => {
  ...
  test('заголовков не меньше 4 и присутствуют 2.0.8, 2.0.7, 2.0.6, 2.0.5, 2.0.4, 2.0.3, 2.0.2, 2.0.1, 2.0.0, 1.19.0, 1.18.0, 1.17.0, 1.16.0, 1.15.3', () => {
