...
## v1.5.0 — 2026-08-15
- Самодиагностика интеграций: если в DOM есть диалог с сообщениями, но сетевой снимок не пришёл за 12 секунд — попап показывает «Интеграция могла устареть: проверьте обновление», виджет показывает «—» вместо 0.0%; на пустых чатах не срабатывает
