...
(function () {
  ...
  window.fetch = function (input, init) {
    // v51 (R1): преамбула в try/catch — исключение здесь не должно ломать
    // window.fetch хост-страницы; silent-fallback на originalFetch (образец v14).
    var url = '';
    var method = '';
    try {
      url = urlOf(input);
